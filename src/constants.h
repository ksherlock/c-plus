...
token const newline{ token_type::ws, "\n" }, // don't test for equality to this; newline runs are condensed
	...
	include_directive{ token_type::directive, "include" },
	define_directive{ token_type::directive, "define" },
	undef_directive{ token_type::directive, "undef" },
	error_directive{ token_type::directive, "error" },
	line_directive{ token_type::directive, "line" },
	if_directive{ token_type::directive, "if" },
	else_directive{ token_type::directive, "else" },
	elif_directive{ token_type::directive, "elif" },
	endif_directive{ token_type::directive, "endif" },
	ifdef_directive{ token_type::directive, "ifdef" },
	ifndef_directive{ token_type::directive, "ifndef" },
	pragma_directive{ token_type::directive, "pragma" },
